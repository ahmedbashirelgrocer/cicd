...
/// real-life card type
@objc public enum CreditCardTypeCustom: Int {
...
public class CCValidator: NSObject {
    ...
    public convenience init(type: CreditCardTypeCustom) {
        // default specs
...
public extension CCValidator {
    ...
    private class func possibleTypesCheckingLengthOnly(creditCardNumber number: String) -> [CreditCardTypeCustom] {
        let allTypes = self.allTypes()
        var possibleTypes: [CreditCardTypeCustom] = []
    ...
    private class func allTypes() -> [CreditCardTypeCustom] {
        return [
            .AmericanExpress,
            .Dankort,
            .DinersClub,
    ...
    class func typeCheckingPrefixOnly(creditCardNumber number: String) -> CreditCardTypeCustom {
    ...
    /// - Returns: Credit Card Type, or `.NotRecognized` if failed to recognize the type
    class func typeCheckingPrefixOnly(creditCardNumber number: String, checkOnlyFromTypes types:[CreditCardTypeCustom]) -> CreditCardTypeCustom {
        var type: CreditCardTypeCustom = .NotRecognized

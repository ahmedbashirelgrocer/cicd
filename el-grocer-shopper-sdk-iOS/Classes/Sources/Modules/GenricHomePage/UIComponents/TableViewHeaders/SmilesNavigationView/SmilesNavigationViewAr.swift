...
class SmilesNavigationViewAr: UIView, SmilesNavigationViewType {
    ...
    func initialSetup() {
        ...
        NSLayoutConstraint.activate([
            ...
            profileButton.rightAnchor.constraint(equalTo: rightAnchor, constant: -6),
        ...
        NSLayoutConstraint.activate([
            ...
            cartButton.leftAnchor.constraint(equalTo: leftAnchor, constant: 6),

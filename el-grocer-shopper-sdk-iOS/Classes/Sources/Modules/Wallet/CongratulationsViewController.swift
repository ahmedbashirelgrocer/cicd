...
class CongratulationsViewController: UIViewController {
    ...
    fileprivate func setCongratulationsLabelAppearance() {
        ...
        self.congratulationsLabel.text = NSLocalizedString("congratiolations", comment: "")
    }
    ...
    fileprivate func setFreeGroceryDescriptionLabelAppearance() {
       ...
       // self.referralDescription.text = NSLocalizedString("congratiolation_referral_description", comment: "")
    ...
    fileprivate func setMoreSharingLabelAppearance() {
        ...
        self.moreSharingLabel.text = NSLocalizedString("congratiolation_keep_sharing_text", comment: "")
    }
    ...
    fileprivate func setInvitationLinkLabelAppearance() {
        ...
        self.invitationLink.text = NSLocalizedString("invitation_code", comment: "")
    }

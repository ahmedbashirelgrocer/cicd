//
//  BottomSheetGroceryCollectionCell.swift
//  ElGrocerShopper
//
//  Created by Abdul Saboor on 09/12/2021.
    ...
    func setDeliveryDate (_ data : String) {
        ...
        if dataA.count == 1 {
            if self.lblSlot.text?.count ?? 0 > 13 {
                attrs1 = [NSAttributedString.Key.font : UIFont(name: "SFProDisplay-Light", size: 9) , NSAttributedString.Key.foregroundColor : self.lblSlot.textColor ]

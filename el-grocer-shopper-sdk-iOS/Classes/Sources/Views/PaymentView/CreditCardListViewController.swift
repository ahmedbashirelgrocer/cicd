...
class CreditCardListViewController: UIViewController {
    ...
    @IBOutlet var btnNext: AWButton! {
        didSet {
            btnNext.setTitle(NSLocalizedString("btn_next", comment: ""), for: UIControl.State())
        }
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if isFromWallet {
            ...
            self.btnCross.isHidden = false
            self.backButtonWidth.constant = 0
            lblChosePayment.text = NSLocalizedString("txt_add_funds_from", comment: "")//NSLocalizedString("Setting_Credit_Card_List", comment: "")
            self.topYSpace.constant = 44

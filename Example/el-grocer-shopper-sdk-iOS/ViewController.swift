...
//        }
    ...
    func setDefaultData() {
        ...
        txtEmail.text = ""
        txtPushPayload.text =  "[{\"key\":\"message\",\"value\":\"Your order is accepted!\"},{\"key\":\"order_id\",\"value\":530912815},{\"key\":\"message_type\",\"value\":1},{\"key\":\"storeID\",\"value\":16},{\"key\":\"customPageId\",\"value\":8},{\"key\":\"origin\",\"value\":\"el-grocer-api\"}]"

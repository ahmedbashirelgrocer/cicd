 ...
 */
@protocol ST_SDWebImageDownloaderResponseModifier <NSObject>
 ...
 */
@interface ST_SDWebImageDownloaderResponseModifier : NSObject <ST_SDWebImageDownloaderResponseModifier>
...
*/
@interface ST_SDWebImageDownloaderResponseModifier (Conveniences)

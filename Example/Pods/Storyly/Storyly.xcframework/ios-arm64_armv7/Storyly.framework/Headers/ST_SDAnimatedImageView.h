...
#import "ST_SDAnimatedImage.h"
#import "ST_SDAnimatedImagePlayer.h"
 ...
 */
@interface ST_SDAnimatedImageView : UIImageView
/**
 ...
 */
@property (nonatomic, strong, readonly, nullable) ST_SDAnimatedImagePlayer *player;

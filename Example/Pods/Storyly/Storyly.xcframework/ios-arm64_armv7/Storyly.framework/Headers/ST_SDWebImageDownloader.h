...
#import "ST_SDWebImageDownloaderConfig.h"
#import "ST_SDWebImageDownloaderRequestModifier.h"
#import "ST_SDWebImageDownloaderResponseModifier.h"
#import "ST_SDWebImageDownloaderDecryptor.h"
 ...
 */
@interface ST_SDWebImageDownloadToken : NSObject <SDWebImageOperation>
 ...
 */
@interface ST_SDWebImageDownloader : NSObject
 ...
 */
@property (nonatomic, copy, readonly, nonnull) ST_SDWebImageDownloaderConfig *config;
 ...
 */
@property (nonatomic, strong, nullable) id<ST_SDWebImageDownloaderRequestModifier> requestModifier;
 ...
 */
@property (nonatomic, strong, nullable) id<ST_SDWebImageDownloaderResponseModifier> responseModifier;
 ...
 */
@property (nonatomic, strong, nullable) id<ST_SDWebImageDownloaderDecryptor> decryptor;
 ...
 */
@property (nonatomic, class, readonly, nonnull) ST_SDWebImageDownloader *sharedDownloader;
 ...
 */
- (nonnull instancetype)initWithConfig:(nullable ST_SDWebImageDownloaderConfig *)config NS_DESIGNATED_INITIALIZER;
 ...
 */
- (nullable ST_SDWebImageDownloadToken *)downloadImageWithURL:(nullable NSURL *)url
 ...
 */
@interface ST_SDWebImageDownloader (SDImageLoader) <SDImageLoader>

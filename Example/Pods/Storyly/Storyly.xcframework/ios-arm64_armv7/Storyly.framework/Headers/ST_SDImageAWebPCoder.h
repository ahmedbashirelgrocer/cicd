...
@interface ST_SDImageAWebPCoder : ST_SDImageIOAnimatedCoder <SDProgressiveImageCoder, SDAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) ST_SDImageAWebPCoder *sharedCoder;

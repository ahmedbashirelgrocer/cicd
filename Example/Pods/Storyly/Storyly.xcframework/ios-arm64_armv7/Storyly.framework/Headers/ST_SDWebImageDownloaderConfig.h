 ...
 */
@interface ST_SDWebImageDownloaderConfig : NSObject <NSCopying>
 ...
 */
@property (nonatomic, class, readonly, nonnull) ST_SDWebImageDownloaderConfig *defaultDownloaderConfig;

 ...
 */
@interface ST_SDImageGIFCoder : ST_SDImageIOAnimatedCoder <SDProgressiveImageCoder, SDAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) ST_SDImageGIFCoder *sharedCoder;

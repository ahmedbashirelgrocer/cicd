...
*/
@protocol ST_SDWebImageDownloaderDecryptor <NSObject>
...
*/
@interface ST_SDWebImageDownloaderDecryptor : NSObject <ST_SDWebImageDownloaderDecryptor>
...
@interface ST_SDWebImageDownloaderDecryptor (Conveniences)

/// Base64 Encoded image data decryptor
@property (class, readonly, nonnull) ST_SDWebImageDownloaderDecryptor *base64Decryptor;

...
@class ST_SDImageCacheConfig;
/**
 A protocol to allow custom memory cache used in SDImageCache.
 */
@protocol ST_SDMemoryCache <NSObject>
 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull ST_SDImageCacheConfig *)config;
 ...
 */
@interface ST_SDMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <ST_SDMemoryCache>

@property (nonatomic, strong, nonnull, readonly) ST_SDImageCacheConfig *config;

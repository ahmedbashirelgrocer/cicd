 ...
 */
@protocol ST_SDDiskCache <NSObject>
 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull ST_SDImageCacheConfig *)config;
 ...
 */
@interface ST_SDDiskCache : NSObject <ST_SDDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) ST_SDImageCacheConfig *config;

...
typedef ST_SDWebImageOptionsResult * _Nullable(^SDWebImageOptionsProcessorBlock)(NSURL * _Nullable url, SDWebImageOptions options, SDWebImageContext * _Nullable context);
 ...
 */
@interface ST_SDWebImageOptionsProcessor : NSObject<SDWebImageOptionsProcessor>

...
@interface ST_SDGraphicsImageRendererFormat : NSObject
...
@interface ST_SDGraphicsImageRenderer : NSObject
...
/// @return An initialized image renderer.
- (nonnull instancetype)initWithSize:(CGSize)size format:(nonnull ST_SDGraphicsImageRendererFormat *)format;

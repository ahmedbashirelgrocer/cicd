 ...
 */
@protocol ST_SDWebImageDownloaderRequestModifier <NSObject>
 ...
 */
@interface ST_SDWebImageDownloaderRequestModifier : NSObject <ST_SDWebImageDownloaderRequestModifier>
...
*/
@interface ST_SDWebImageDownloaderRequestModifier (Conveniences)

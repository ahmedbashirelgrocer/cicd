...
@interface ST_SDImageHEICCoder : ST_SDImageIOAnimatedCoder <SDProgressiveImageCoder, SDAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) ST_SDImageHEICCoder *sharedCoder;

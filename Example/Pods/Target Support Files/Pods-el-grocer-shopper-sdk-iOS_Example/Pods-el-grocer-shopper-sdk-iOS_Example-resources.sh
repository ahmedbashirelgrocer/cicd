...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/Adyen/AdyenActions.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/Adyen/AdyenCard.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/Adyen/Adyen.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/CleverTap-iOS-SDK/CleverTapSDK.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/el-grocer-shopper-sdk-iOS/el-grocer-shopper-sdk-iOS.bundle"
fi
